                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->recept") }}"
                                                    data-caption="صورة ايصال آخر سداد">
                                                    <img src="{{ asset("web/$img->recept") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة ايصال آخر سداد</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
