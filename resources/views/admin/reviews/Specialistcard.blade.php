                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->master") }}"
                                                    data-caption="صورة أصل الماجستير">
                                                    <img src="{{ asset("web/$img->master") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة أصل الماجستير</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
