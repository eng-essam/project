                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->hospital") }}"
                                                    data-caption="صورة اصل فاتورة المستشفي معتمدة ومختومة">
                                                    <img src="{{ asset("web/$img->hospital") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة اصل فاتورة المستشفي معتمدة ومختومة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->report") }}"
                                                    data-caption="صورة التقرير الطبي موضح به نوع الجراحة">
                                                    <img src="{{ asset("web/$img->report") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة التقرير الطبي موضح به نوع الجراحة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->wedding") }}"
                                                    data-caption="صورة قسيمة زواج في حالة إجراء الجراحة للزوجة">
                                                    <img src="{{ asset("web/$img->wedding") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة قسيمة زواج في حالة إجراء الجراحة للزوجة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->birth") }}"
                                                    data-caption="صورة شهادة ميلاد الذي سيخصع للجراحة">
                                                    <img src="{{ asset("web/$img->birth") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة ميلاد الذي سيخصع للجراحة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->receipt") }}"
                                                    data-caption="صورة ايصال آخر سداد اشتراك كارنيه النقابة">
                                                    <img src="{{ asset("web/$img->receipt") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة ايصال آخر سداد اشتراك كارنيه النقابة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
