                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->death") }}"
                                                    data-caption="صورة شهادة الوفاه">
                                                    <img src="{{ asset("web/$img->death") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة الوفاه</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->funeral") }}"
                                                    data-caption="صورة إداريه معنمدة يحدد فيها القائم بمصاريف الجنازة">
                                                    <img src="{{ asset("web/$img->funeral") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة إداريه معنمدة يحدد فيها القائم بمصاريف الجنازة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->personal_card") }}"
                                                    data-caption="صورة لمن قام بالصرف ">
                                                    <img src="{{ asset("web/$img->personal_card") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة لمن قام بالصرف </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
