                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->medical") }}"
                                                    data-caption="صورة قرار من الكومسيون الطبي او الهيئة العامة للتأمين الصحي تفيد بالعجز الكلي او الجزئي">
                                                    <img src="{{ asset("web/$img->medical") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة قرار من الكومسيون الطبي او الهيئة العامة للتأمين الصحي تفيد بالعجز الكلي او الجزئي</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
