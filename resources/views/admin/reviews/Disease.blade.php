                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->report") }}"
                                                    data-caption="صورة تقرير طبي بالحالة من الطبيب المعالج او احد المستشفيات مختوم بختم المستشفي">
                                                    <img src="{{ asset("web/$img->report") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة تقرير طبي بالحالة من الطبيب المعالج او احد المستشفيات مختوم بختم المستشفي</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
