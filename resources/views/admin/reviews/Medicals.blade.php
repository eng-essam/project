                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->childrens") }}"
                                                    data-caption="صورة شهادات ميلاد الابناء">
                                                    <img src="{{ asset("web/$img->childrens") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادات ميلاد الابناء</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->childrenspersonal") }}"
                                                    data-caption="صور الابناء">
                                                    <img src="{{ asset("web/$img->childrenspersonal") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صور الابناء</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
