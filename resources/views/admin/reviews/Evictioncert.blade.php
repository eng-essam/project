                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->health") }}"
                                                    data-caption="صورة افادة من الصحة بعدم إداراة اى صيدليه">
                                                    <img src="{{ asset("web/$img->health") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة افادة من الصحة بعدم إداراة اى صيدليه</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->card") }}"
                                                    data-caption="صورة الكارنيه الفرعي">
                                                    <img src="{{ asset("web/$img->card") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة الكارنيه الفرعي</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->attorney") }}"
                                                    data-caption="صورة التوكيل في حالة عدم وجود الصيدلي">
                                                    <img src="{{ asset("web/$img->attorney") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة التوكيل في حالة عدم وجود الصيدلي</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
