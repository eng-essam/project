                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->hospital") }}"
                                                    data-caption="صورة أصل فاتورة المستشفي معتمدة ومختومة">
                                                    <img src="{{ asset("web/$img->hospital") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة أصل فاتورة المستشفي معتمدة ومختومة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->report") }}"
                                                    data-caption="صورة تقرير طبي موضح به نوع الوضع">
                                                    <img src="{{ asset("web/$img->report") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة تقرير طبي موضح به نوع الوضع</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->childs") }}"
                                                    data-caption="صورة شهادة ميلاد الطفل معتمدة ومختومة">
                                                    <img src="{{ asset("web/$img->childs") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة ميلاد الطفل معتمدة ومختومة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
