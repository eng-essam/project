                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->birth") }}"
                                                    data-caption="صورة شهادة الميلاد للطالب أو الطالبة">
                                                    <img src="{{ asset("web/$img->birth") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة الميلاد للطالب أو الطالبة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->edu_certificate") }}"
                                                    data-caption="صورة شهادة قيد للطالب مختوم بختم من المدرسة أو الجامعة">
                                                    <img src="{{ asset("web/$img->edu_certificate") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة قيد للطالب مختوم بختم من المدرسة أو الجامعة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->salary") }}"
                                                    data-caption="صورة مفردات مرتب الزوج أو الزوجة">
                                                    <img src="{{ asset("web/$img->salary") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة مفردات مرتب الزوج أو الزوجة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
