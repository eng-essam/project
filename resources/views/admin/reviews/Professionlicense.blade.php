                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->model") }}"
                                                    data-caption="صورة نموذج صحة">
                                                    <img src="{{ asset("web/$img->model") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة نموذج صحة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->graduation") }}"
                                                    data-caption="صورة شهادة التخرج">
                                                    <img src="{{ asset("web/$img->graduation") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة التخرج</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->excellence") }}"
                                                    data-caption="صورة شهادة الامتياز">
                                                    <img src="{{ asset("web/$img->excellence") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة الامتياز</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->birth") }}"
                                                    data-caption="صورة شهادة الميلاد">
                                                    <img src="{{ asset("web/$img->birth") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة الميلاد</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->fesh") }}"
                                                    data-caption="صورة فيش وتشبيه">
                                                    <img src="{{ asset("web/$img->fesh") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة فيش وتشبيه</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->situation") }}"
                                                    data-caption="صورة الموقف من التجنيد">
                                                    <img src="{{ asset("web/$img->situation") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة الموقف من التجنيد</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->certificate") }}"
                                                    data-caption="صورة أصل شهادة المعادلة">
                                                    <img src="{{ asset("web/$img->certificate") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة أصل شهادة المعادلة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
