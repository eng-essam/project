                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->temporary") }}"
                                                    data-caption="صورة أصل الدكتوراه المؤقتة">
                                                    <img src="{{ asset("web/$img->temporary") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة أصل الدكتوراه المؤقتة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
