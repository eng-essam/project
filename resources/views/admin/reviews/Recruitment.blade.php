                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->recruitment") }}"
                                                    data-caption="صورة إثبات تجنيد من الوحده">
                                                    <img src="{{ asset("web/$img->recruitment") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة إثبات تجنيد من الوحده</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->army_card") }}"
                                                    data-caption="صورة الكارنيه الجيش">
                                                    <img src="{{ asset("web/$img->army_card") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة الكارنيه الجيش</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
