                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->personal_card") }}"
                                                    data-caption="صورة البطاقة">
                                                    <img src="{{ asset("web/$img->personal_card") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة البطاقة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->License") }}"
                                                    data-caption="صورة ترخيص مزاولة المهنه">
                                                    <img src="{{ asset("web/$img->License") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة ترخيص مزاولة المهنه</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->recruitment") }}"
                                                    data-caption="صورة التجنيد (مذكر)">
                                                    <img src="{{ asset("web/$img->recruitment") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة التجنيد (مذكر)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->assignment") }}"
                                                    data-caption="صورة إلغاء التكليف">
                                                    <img src="{{ asset("web/$img->assignment") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة إلغاء التكليف</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->statement") }}"
                                                    data-caption="صورة إفادة من جهة العمل بالمدة التي قضاها في التكليف">
                                                    <img src="{{ asset("web/$img->statement") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة إفادة من جهة العمل بالمدة التي قضاها في التكليف</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->movements") }}"
                                                    data-caption="صورة شهادة تحركات من الصحة">
                                                    <img src="{{ asset("web/$img->movements") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة شهادة تحركات من الصحة</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
