                                        ...
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->contract") }}"
                                                    data-caption="صورة عقد إيجار">
                                                    <img src="{{ asset("web/$img->contract") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة عقد إيجار</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->engineer") }}"
                                                    data-caption="صورة أصل رسم هندسي موضح به مصدر المياه معتمد من مكتب هندسي">
                                                    <img src="{{ asset("web/$img->engineer") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة أصل رسم هندسي موضح به مصدر المياه معتمد من مكتب هندسي</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->tax_card") }}"
                                                    data-caption="صورة البطاقة الضريبيه">
                                                    <img src="{{ asset("web/$img->tax_card") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة البطاقة الضريبيه</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->approval") }}"
                                                    data-caption="صورة موافقة النقابه الفرعيه">
                                                    <img src="{{ asset("web/$img->approval") }}" alt="image">
                                                </a>
                                                <p class="mt-2">صورة موافقة النقابه الفرعيه</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-12 mb-4">
                                <div class="cardimg">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between px-md-1">
                                            <div class="align-self-center">
                                                <a data-fancybox="gallery" href="{{ asset("web/$img->presonal") }}"
                                                    data-caption="صورة شخصية">
                                                    <img src="{{ asset("web/$img->presonal") }}" alt="image">
                                                </a>
