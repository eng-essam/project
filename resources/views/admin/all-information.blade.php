    ...
    <div class="card" style="direction: rtl">
        ...
        <div class="card-header">
            ...
            <div style="text-align: center;display: inline-block ;float: right;height: 33px;">
                <a href="{{ url('/admin/add/information') }}">
                ...
                @foreach ($information as $info)
                    ...
                    <div class="col">
                        <div style="border:1px #3C4147 solid ;" class="card">
                            ...
                            <div style="text-align: right;height: 130px;" class="card-body">
                                <!-- عنوان الخبر -->
                            ...
                            <a style="text-align: center;text-decoration: none;font-weight: bold;margin-top: 10px;"
                                href="{{ url("/admin/one/information/$info->id") }}">المزيد</a>

                            <p style="margin: 5px" class="card-text">
                                <small class="text-muted">
                                    <i style="color: blue;margin-left: 3px" class="fas fa-clock"></i>
                                    <span>{{ Carbon\Carbon::parse($info->created_at)->format('Y-m-d') }}</span>
                                </small>
                            </p>

                            <div style="background-color:#3C4147 ;display: grid;grid-template-columns: repeat(2,50%);justify-items: center;"
                                class="card-footer">
                                <a href="{{ url('admin/information/delete/' . $info->id) }}"><i
                                        style="color:red ;font-size:x-large;" class="fas fa-trash-alt"></i></a>
                                <a href="{{ url('admin/information/eidt/' . $info->id) }}"><i style="font-size:x-large;"
