                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group main">
                                    <label>شهادات ميلاد الابناء :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control" type="file" id="formFileDisabled" name="childrens" />
                                        </div>
                                        <div>
                                            <small class="text-success">عند وجود اكتر من ابن تدمج الصور في صوره واحده</small>
                                        </div>
                                        @error('childrens')
                                            <div>
                            ...
                            <div style="margin-bottom: 30px" class="col-md-6">
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة الابناء:</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="childrenspersonal">
                                        </div>
                                        <div>
                                            <small class="text-success">عند وجود اكتر من ابن تدمج الصور في صوره واحده</small>
                                        </div>
                                        @error('childrenspersonal')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
                                            </div>
                                        @enderror
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label> صورة قسيمة الزواج :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="wedding">
                                        </div>
                                        @error('wedding')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
