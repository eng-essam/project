                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group main">
                                    <label> صورة إفادة من الصحة بعدم إدارة أي صيدلية :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control" type="file" id="formFileDisabled" name="health" />
                                        </div>
                                        @error('health')
                                            <div>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة الكارنيه الفرعي :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                            ...
                            <div style="margin-bottom: 30px" class="col-md-6">
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة التوكيل فى حالة عدم وجود الصيدلي :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="attorney">
                                        </div>
                                        @error('attorney')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
