                    ...
                    <div class="card-body" style="direction: rtl">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة اصل رسم هندسي موضح بيه مصدر
                                        المياه معتمد من مكتب هندسي :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="engineer">
                                        </div>
                                        @error('engineer')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صور سداد اشتراك النقابة حتي العام
                                        الحالي :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                ...
                                <div class="form-group main">
                                    ...
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="tax_card">
                                        </div>
                                        @error('tax_card')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
                            ...
                            <div style="margin-bottom: 30px" class="col-md-6">
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة موافقة النقابة الفرعية:</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="approval">
                                        </div>
                                        @error('approval')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="form-group main">
                                    ...
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="presonal">
                                        </div>
                                        @error('presonal')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
