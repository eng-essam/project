                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group main">
                                    <label>صورة أصل شهادة الوفاة :</label>

                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control" type="file" id="formFileDisabled" name="death" />
                                        </div>
                                        @error('death')
                                            <div>
                                ...
                                <div class="form-group main">
                                    <label
                                    >صورة شهادة إدارية معتمدة يحدد فيها القائم بصرف مصاريف
                                    الجنازة :</label>

                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="funeral">
                                        </div>
                                        @error('funeral')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة البطاقة لمن قام بالصرف:</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
