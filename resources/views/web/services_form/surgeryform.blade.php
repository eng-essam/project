                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group main">
                                    <label> اصل فاتورة المستشفى معتمدة ومختومة :</label>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>تصوير التقرير الطبى موضح به نوع الجراحة:</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                            ...
                            <div style="margin-bottom: 30px" class="col-md-6">
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة ايصال اخر سداد اشتراك كارنيه النقابة:</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة شهادة ميلاد الشخص الذي سيخضع للجراحة :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة قسيمة زواج فى حالة إجراء جراحة للزوجة :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
