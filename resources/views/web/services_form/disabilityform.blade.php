                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group main">
                                    <label>قرار من الهيئة العامة للتأمين الصحي تفيد بالعجز الكلي او الجزئي :</label>

                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control" type="file" id="formFileDisabled" name="medical" />
                                        </div>
                                        @error('medical')
                                            <div>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة إيصال اخر سداد اشتراك النقابة :</label>
