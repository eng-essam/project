                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                ...
                                <li class="mb-3">طلب نقل من الجدول العام إلي جدول غير المشتغلين أو خطاب من التأمينات موجه للنقابة العامة</li>
                                <li class="mb-3">سداد رسوم الشهادة الإدارية 105 جنيه</li>
                                <li class="mb-3">سداد رسوم الشطب 2005 جنيه</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-networks">

                            <!-- ادخل-->
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul class="ul">
                                        <li>صورة إخلاء طرف من جهة العمل معتمد ومختوم</li>
                                        <li>صورة إقرار بالتفرغ يملىء بواسطة الطبيب</li>
                                        <li>صورة كارنيه النقابة</li>
                                        <li>صورة البطاقة الشخصية</li>
                                        <li>صورة إفادة من وزارة الصحة تفيد بقيده بجدول المشغولين</li>
                                        <li>صورة قرار انهاء الخدمة معتمد ومختوم من من الجهة التي يعمل بها (حكومي فقط)</li>
                                        <li>صورة برنت من التأمينات الاجتماعية بانهاء الخدمة (حكومي فقط)</li>
                                        <li>استمارة 6 تأمينات (خاص فقط)</li>
                                    </ul>
                                </div>
                            </div>
