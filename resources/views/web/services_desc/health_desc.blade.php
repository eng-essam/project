                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                ...
                                <li class="mb-3"> إحضار شهادة أن العضو لم يستفد من المشروع</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-health">
                            ...
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul style="font-size: 18px">
                                        ...
                                        <li>أصل التقرير الطبي المعتمد من اللجنة الطبية أو
                                            المستشفي</li>
                                        <li>مفردات مرتب مبين بها خصم الاشتراك بصندوق (نقابة
                                            المعلمين)</li>
                                        <li>إفادة الاشتراك في الصندوق (نقابة المعلمين)</li>
                                        <li>صحيفة أحةال إلكترونية حديثة (نقابة المعلمين)</li>
                                        <li>فواتير معتمدة من المستشفي (نقابة المحامين)</li>
                                    </ul>
                                </div>
                            </div>
