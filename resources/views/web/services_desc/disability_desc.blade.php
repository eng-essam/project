                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                <li class="mb-3">أن يكون العضو غير حاصل علي معاش النقابة او اي معاش اخر</li>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-disability">

                            <!-- ادخل-->
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul class="ul">
                                        <li>قرار من الكومسيون الطبي او الهيئة العامة للتأمين الصحي تفيد بالعجز الكلي او
                                            الجزئي</li>
                                        <li>صورة البطايقة الشخصية</li>
                                        <li>صورة إيصال اخر سداد اشتراك النقابة</li>
                                    </ul>
                                </div>
                            </div>
