                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                ...
                                <li class="mb-3"> تقريرين معتمدين من استاذين متخصصين الحدى األمراض
المزمنة المنصوص عليها </li>
                                <li class="mb-3">يقدم التقرير فى يناير من كل عاد للحالات القائمة او اعتبارا من تاريخ التقرير حتى نهاية ديسمبر بالنسبة للحالات الجديدة</li>
                            </ul>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-treatments">

                            <!-- ادخل-->
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul class="ul">
                                        <li>صورة تقريرين معتمدين من استاذين لاحدي الأمراض
                                            المزمنة</li>
                                        <li>صورة البطاقة الشخصية</li>
                                        <li>صورة إيصال آخر سداد اشتراك النقابة</li>
                                    </ul>
                                </div>
                            </div>
