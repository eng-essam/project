                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                ...
                                <li class="mb-3">أن يقوم بصرف الاعانة سواء فى فترة الحبس احتياطيا أو بعد خروجه بشرط ألا تزيد الفترة عن سنة ميلادية من تاريخ خروجه</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-conditions">

                            <!-- ادخل-->
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul class="ul">
                                        <li>صورة شهادة من النيابة العامة او نيابة امن الدولة
                                            تفيد ان العضو محبوس احتياطياً</li>
