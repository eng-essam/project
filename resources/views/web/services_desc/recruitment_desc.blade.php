                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                <li class="mb-3">أن يكون العضو فى فترة التجنيد ولا يجوز صرف المبلغ بعد انتهاء فترة التجنيد</li>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-recruitments">

                            <!-- ادخل-->
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul class="ul">
                                        <li>أصل إثبات تجنيد من الوحدة</li>
                                        <li>صورة كارنيه الجيش</li>
                                        <li>صورة كارنيه النقابة</li>
                                        <li>إيصال اشتراك النقابة العام</li>
                                    </ul>
                                </div>
                            </div>
