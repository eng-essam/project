                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" style="direction: rtl">
                        ...
                        <div class="service-condition">
                            ...
                            <ul>
                                <li class="mb-3">تقرير طبى بالحالة من الطبيب المعالج او احد من المستشفيات مختوم
                                    بختم المستشفي</li>
                                <li class="mb-3"> تقديم تقرير يفيد سداد اشتراك النقابة إلى تاريخ تقديم الطلب</li>
                                <li class="mb-3">ألا يكون العضو مستفيد من إعانة العلاج الشهري أو أي إعانة أخري من عن نفس المرض</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body" style="direction: rtl">
                    <div class="row">
                        ...
                        <!-- الجانب الايسر-->
                        <div class="col-md-6 left left-diseases">

                            <!-- ادخل-->
                            <div class="form-group main">
                                <div class="input-group inner" style="direction: rtl">
                                    <ul class="ul">
                                        <li>صورة تقرير طبى بالحالة من الطبيب المعالج او احد المستشفيات مختوم بختم المستشفى
                                        </li>
