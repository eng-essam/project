                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group main mobile-hidden">
                                        <img src="{{ asset('style_member/assets/img/values-3.png') }}"
                                            class="img-fluid" alt="" />
                                    </div>
                                ...
                                <!-- الجانب الايسر-->
                                <div  class="col-md-6 left left-professionlicenses">
                                    ...
                                    <div class="form-group main">
                                        <div class="input-group inner"
                                            style="direction: rtl">
                                            <ul class="ul">
                                                <li>صورة نموذج صحة</li>
                                                <li>صورة اصل شهادة التخرج</li>
                                                <li>أصل شهادة الامتياز</li>
                                                <li>صورة شهادة الميلاد</li>
                                                <li>صورة شخصية</li>
                                                <li>صورة فيش وتشبيه</li>
                                                <li>صورة الموقف من التجنيد</li>
                                                <li>صورة ايصال اشتراك النقابة</li>
                                                <li>اصل شهادة المعادلة (في حالة
                                                    الجامعات الخاصة)</li>
                                            </ul>
                                        </div>
                                    </div>
