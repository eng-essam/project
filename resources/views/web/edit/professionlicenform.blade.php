                    ...
                    <div class="card-body" style="direction: rtl">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة ترخيص قديم أو صورة من الشهادة المؤقتة :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                            ...
                            <div style="margin-bottom: 30px" class="col-md-6">
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة جواز سفر (في حالة الترخيص الموجه للخارج) :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="passport">
                                        </div>
                                        @error('passport')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
