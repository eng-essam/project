                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group main">
                                    <label>أصل فاتورة المستشفي معتمدة ومختومة :</label>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>تقرير طبي موضح به نوع الوضع :</label>
                                ...
                                <!-- ادخل-->
                                <div class="form-group main">
                                    <label>صورة شهادة ميلاد الطفل معتمدة ومختومة :</label>
                                    <div class="input-group inner" style="direction: rtl">
                                        <div>
                                            <input class="form-control mb-2" type="file" id="formFile" name="childs">
                                        </div>
                                        @error('childs')
                                            <div>
                                                <small class="text-danger">{{ $message }}</small>
