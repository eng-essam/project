...
@section('main')
    <div class="card card-danger">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('/superadmin/add/information') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div style="margin-bottom: 30px" class="form-group">
                                    ...
                                    <div style="display: block;" class="input-group">
                                        <div>
                                            <input type="text" class="form-control" value="{{ old('header') }}"
                                                name="header">
                                        </div>
                                ...
                                <div style="margin-bottom: 30px" class="form-group">
                                    ...
                                    <div style="display: block;" class="input-group">
                                        <input type="text" class="form-control" value="{{ old('titel') }}" name="titel">
                                        <div style="color: red ;font-size:15px;float: right;">
                                            @error('titel')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div style="margin-bottom: 30px" class="form-group">
                                    ...
                                    <div style="display: block;" class="input-group">
                                            <input class="form-control " value="{{old('img')}}" type="file" id ="formFile" name="img" />
                                        <div style="color: red ;font-size:15px;float: right;">
                                            @error('img')
                                                {{ $message }}
                                            @enderror
