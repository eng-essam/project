...
return [
    ...
    'custom' => [
        ...
        'header' => [
            'required' => 'يرجى كتابة عنوان للخبر',
            'string' => 'يرجى كتابة عنوان للخبر',
        ],

        'titel' => [
            'required' => 'يرجى كتابة محتوى الخبر',
            'string' => 'يرجى كتابة محتوى الخبر',
        ],

        'img' => [
            'required' => 'يرجى رفع صورة للخبر',
            'image' =>'يرجى رفع صورة للخبر',
        ],
